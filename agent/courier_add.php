...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($senderName == '' || $receiverName == '' || $fromLocation == '' || $toLocation == '') {
        ...
        if (mysqli_stmt_execute($insert)) {
            header('Location: ' . BASE_URL . '/agent/couriers.php?added=1');
            exit;
        } else {
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card form-card p-4 p-md-5">
                        ...
                        <p class="text-muted small mb-4">Book a new consignment for your branch.</p>

                        <?php if ($error): ?>
                            <div class="alert alert-danger"><?php echo $error; ?></div>
                        <?php endif; ?>

                        <form method="POST" action="<?php echo BASE_URL; ?>/agent/courier_add.php">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="from_location" class="form-control" value="<?php echo htmlspecialchars($agent['city']); ?>" required>
                                </div>
                                <div class="col-md-6">
