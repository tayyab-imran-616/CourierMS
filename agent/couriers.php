...
$couriers = mysqli_stmt_get_result($stmt2);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <main class="py-5">
        <div class="container">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                <h2 class="h4 mb-0">Manage Couriers - <?php echo htmlspecialchars($city); ?></h2>
                <a href="<?php echo BASE_URL; ?>/agent/courier_add.php" class="btn btn-brand">
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>/agent/courier_edit.php?id=<?php echo $c['id']; ?>"><i class="fa-solid fa-pen me-2"></i>Update Status</a></li>
                                            ...
                                            <li>
                                                <form method="POST" action="<?php echo BASE_URL; ?>/agent/sms_send.php">
